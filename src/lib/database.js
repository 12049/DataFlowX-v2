...
const CONFIG = {
  owner: "fazbear-Official", // اسم الحساب على GitHub
  repo: "BLACKWAVE_API", // اسم الريبو
  token: "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", // التوكن الخاص بـ GitHub
  encryptionKey: process.env.DB_ENCRYPTION_KEY || "Online_Storage_Secret", // مفتاح التشفير
  cacheTTL: 300000,  
};
...
// إنشاء instance من GitHubDB
const githubDB = new GithubDB();

// لتخزين البيانات على GitHub DB
export { githubDB, GithubDB };
